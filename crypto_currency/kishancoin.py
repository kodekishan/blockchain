...
def mine_block():
  ...
  blockchain.add_transaction(sender = node_address, receiver = 'Kishan', amount = 1)
...
def connect_node():
  ...
  response = {'message': 'All the nodes are now connected. The kishancoin blockchain now contains the following nodes:', 
